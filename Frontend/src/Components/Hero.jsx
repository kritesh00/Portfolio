function Hero(){
    return(
        ...
        <div className = 'display-flex justify-center align-center h-150 w-150 bg-white/10 rounded-xl border border-white/20 shadow-2xl backdrop-blur-xl mt-40 mx-auto'>
            <h1 className='text-4xl text-white text-center'>Welcome to My Portfolio</h1>
            ...
            <div class="  ml-30 w-96 px-6 py-6  text-center bg-gray-800 rounded-lg lg:mt-5 xl:px-10">
    <div class="space-y-4 xl:space-y-6">
        <img class="mx-auto rounded-full h-36 w-36" src="avatar.png" alt="author avatar"/>
        <div class="space-y-2">
            <div class="flex justify-center items-center flex-col space-y-3 text-lg font-medium leading-6">
                <h3 class="text-white">Kritesh Bhattarai</h3>
                <p class="text-indigo-300">Student- Computer Engineering</p>
