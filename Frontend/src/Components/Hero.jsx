function Hero(){
    return(
        ...
        <div className = ' pt-10 display-flex justify-center align-center h-150 w-150 bg-white/10 rounded-xl border border-white/20 shadow-2xl backdrop-blur-xl mt-10 mx-auto'>
            ...
            <div className="  ml-30 w-96 px-6 py-6  text-center bg-gray-800 rounded-lg lg:mt-5 xl:px-10">
    <div className="space-y-4 xl:space-y-6">
        <img className="mx-auto rounded-full h-36 w-36" src="avatar.png" alt="author avatar"/>
        <div className="space-y-2">
            <div className="flex justify-center items-center flex-col space-y-3 text-lg font-medium leading-6">
                <h3 className="text-white">Kritesh Bhattarai</h3>
                <p className="text-indigo-300">Student- Computer Engineering</p>
