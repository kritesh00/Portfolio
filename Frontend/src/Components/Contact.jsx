function Contact(){
    return(
      ...
      <div>
        <h2 className="text-[#F3F4F4] font-poppins text-3xl font-bold">Let's Talk</h2>
        <p className="text-[15px] text-[#F3F4F4] mt-4 leading-relaxed">Work Together? Contact Me</p>
        <div className="mt-12">
          <h2 className="text-[#F3F4F4] text-base font-semibold">Email</h2>
          <ul className="mt-4">
            <li className="flex items-center">
              <div className="bg-[#F3F4F4] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              ...
              <a href="javascript:void(0)" className="text-sm ml-4">
                ...
                <spane className="font-semibold text-[#F3F4F4]">kriteshbhattarai617@gmail.com.com</spane>
              </a>
            </li>
          </ul>
        </div>
